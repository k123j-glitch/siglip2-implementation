...
from model_siglip_2 import siglip2_loss, SigLIP2
...
def train():
    ...
    model = SigLIP2(vocab_size=vocab_size).to(device)
    ...
    # TensorBoard Setup
    # -----------------------
    log_dir = f"runs/siglip2_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
